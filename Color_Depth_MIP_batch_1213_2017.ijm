...
//Dialog.addCheckbox("Unsharp mask", unsharp);
Dialog.addCheckbox("Expand canvas for scale-bar", expand);
Dialog.addCheckbox("01_warp MIP craetion", nc82nrrd);
...
Dialog.addRadioButtonGroup("Channel discrimination method", item4, 1, 3, manualST); 
...
if(AutoBRV==1){
	...
	Dialog.addNumber("2nd mean value, jump to...", secondjump);
